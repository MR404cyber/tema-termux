...
def pasang():
    ...
    tema = open(".bashrc", 'w')
    tema.write("""
#Created By MR.404 Kode Developer
clear
echo "
\033[31;1m█████████████████   \033[37;1m[\033[41;1mKALIMANTAN CYBER TEAM\033[00;1m\033[37;1m]
\033[31;1m█████████████████
...
"""% nama)
    ...
    print("\n\033[42;1mJangan Lupa Subscribe Channel MR.404\033[00;1m")
...
def kembali():
    os.system("clear")
    exit("\033[34;1mJangan Lupa Subscribe Channel MR.404:)")
main()
